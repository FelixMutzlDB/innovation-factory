...
- OpenAPI client: `src/innovation-factory/ui/lib/api/` (auto-generated)
- Routes: `src/innovation-factory/ui/routes/`
- Components: `src/innovation-factory/ui/components/`
- Backend: `src/innovation-factory/backend/`
